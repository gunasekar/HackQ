<!DOCTYPE html>
<!-- saved from url=(0152)https://accounts.google.com/ServiceLogin?service=mail&passive=true&rm=false&continue=https://mail.google.com/mail/&ss=1&scc=1&ltmpl=default&ltmplcache=2 -->
...
<link rel="publisher" href="https://plus.google.com/103345707817934461425">
  <script type="text/javascript" async="" src="./Gmail  Email from Google_files/ga.js"></script></head>
  <body>
  <div class="wrapper">
  <div class="google-header-bar">
  <div class="header content clearfix">
  <img class="logo" src="./Gmail  Email from Google_files/google_logo_41.png" alt="Google">
  <span class="signup-button">
  New to Gmail?
  <a id="link-signup" class="g-button g-button-red" href="https://accounts.google.com/SignUp?service=mail&continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&ltmpl=default">
  Create an account
  </a>
  </span>
  </div>
...
<div class="signin-box">
  ...
  <input type="hidden" name="dsh" id="dsh" value="-8906710045931416011">
  ...
  <input type="hidden" name="GALX" value="UOkaWe6y4D4">
  <input type="hidden" id="pstMsg" name="pstMsg" value="1">
  <input type="hidden" id="dnConn" name="dnConn" value="">
  <input type="hidden" id="checkConnection" name="checkConnection" value="youtube:521:1">
...
<div class="passwd-div">
  ...
  <ul>
  <li>
  <a id="link-forgot-passwd" href="https://accounts.google.com/RecoverAccount?service=mail&continue=https%3A%2F%2Fmail.google.com%2Fmail%2F" target="_top">
...
<ul class="features">
  <li>
  <img src="./Gmail  Email from Google_files/filing_cabinet-g42.png" alt="">
  <p class="title">Lots of space</p>
  <p>
  Over <span id="quota">7684.844380</span> megabytes (and counting) of free storage.
  </p>
  </li>
  <li>
  <img src="./Gmail  Email from Google_files/nosign-r42.png" alt="">
  <p class="title">Less spam</p>
  <p>Keep unwanted messages out of your inbox.</p>
  </li>
  <li>
  <img src="./Gmail  Email from Google_files/mobile_phone-42.gif" alt="">
  <p class="title">Mobile access</p>
  <p>Get Gmail on your mobile phone. <a href="http://www.google.com/intl/en_IN/mobile/mail/#utm_source=en_IN-cpp-g4mc-gmhp&utm_medium=cpp&utm_campaign=en_IN">Learn more</a></p>
  </li>
</ul>
<ul class="mail-links">
  ...
  About Gmail</a></li>
  <li><a href="http://mail.google.com/mail/help/intl/en/about_whatsnew.html" onclick="_gaq.push([&#39;_link&#39;, &#39;http://mail.google.com/mail/help/about_whatsnew.html&#39;, &#39;true&#39;]); return false;">New features!</a></li>
  ...
  <div class="mailPromo">
  <img src="./Gmail  Email from Google_files/apps-64.png" style="float: left; padding-right: 9px; padding-bottom: 45px;">
  <h4>Take Gmail to work with Google Apps for Business</h4>
  <p class="mailPromoBody">Love Gmail, but looking for a custom email address for your company?<br>
  Get business email, calendar, and online docs @your_company.com.
  <a href="http://www.google.com/apps/intl/en/business/gmail.html#utm_campaign=en&utm_source=gmail_en_US&utm_medium=et&utm_term=login_promo">
  Learn more</a></p>
  </div>
  </div>
  <div id="cc_iframe_parent"><iframe style="visibility: hidden; width: 1px; height: 1px; position: absolute; top: -100px; " src="./Gmail  Email from Google_files/CheckConnection.html" id="youtube"></iframe></div>
  </div>
<div class="google-footer-bar">
  ...
  <form>
  <select id="lang-chooser" class="lang-chooser" style="">
  <option value="ms">
  Bahasa Malaysia
  </option>
  <option value="ca">
...
"message",Gy(c));for(d=0;d<b;d++)c[d].n()}}},GA=function(){if(window.__CHECK_CONNECTION_CONFIG){var a=window.__CHECK_CONNECTION_CONFIG.postMsgSupportElementId;if(window.postMessage){var b=document.getElementById(a);b?b.value="1":Gs.a("Unable to locate the input element to storepostMessage test result",["element id: "+a])}}};G_checkConnectionMain=Gs.j(Gz);G_setPostMessageSupportFlag=Gs.j(GA);
    ...
    window.__CHECK_CONNECTION_CONFIG = {
        ...
        domainConfigs: [{iframeUri: 'https://accounts.youtube.com/accounts/CheckConnection?pmpo\75https%3A%2F%2Faccounts.google.com\46v\75-1764056453',domainSymbol: 'youtube'}],
